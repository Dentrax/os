...
$(eval $(call build-package,go-1.18,1.18.9-r0))
$(eval $(call build-package,go-1.19,1.19.4-r0))
...
$(eval $(call build-package,libxml2,2.10.3-r1))
...
$(eval $(call build-package,wasi-libc,0.20220525-r0))
$(eval $(call build-package,jenkins,2.386-r0))
...
$(eval $(call build-package,php,8.2.1-r0))
...
$(eval $(call build-package,haproxy,2.6.7-r0))
...
$(eval $(call build-package,glib,2.74.3-r1))
...
$(eval $(call build-package,py3-dateutil,2.8.2-r0))
$(eval $(call build-package,py3-docutils,0.19-r0))
